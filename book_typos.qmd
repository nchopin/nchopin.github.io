...
* 15, (2.2): $v_{t-1}$ would make more sense (this way, we are able to predict
  $X_t$ at time $t-1$) (Frank van der Meulen)
...
* 131, grey box: missing $dx_t$ in the Dirac mass (RHS of first and second
  formulae, Frank van der Meulen)
...
* 144, Example 10.4: same typo as the one on p. 15, see above (Frank van der
  Meulen)
...
* 335, line 1: equal(s) (Frank van der Meulen)

* 342, (17.5): $p_t^\theta$ should be $p_T^\theta$

* 363 (bottom)-364 (top): distribution of $V_t|U_t=u_t$ should be $N(\phi u_t, 1-\phi^2)$,
  i.e. $\phi$ instead of $\rho$. Same substitution in the distribution of $Y_t$
  given $X_{t}$ and $X_{t-1}$ (but expression for $u_t$ is correct as is).
  (Javier Burroni)

* 373: remove 'his' in 'The intuition behind this...' (Javier Burroni)
